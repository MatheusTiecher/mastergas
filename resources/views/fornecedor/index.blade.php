	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Selecione o tipo do fornecedor</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body" align="center">
				<a href="{{route('fornecedor.createpf')}}" type="button" class="btn btn-primary" data-toggle="tooltip" title="Pessoa Física"><i class="fas fa-user-friends"></i> Pessoa Física</a>
				<a href="{{route('fornecedor.createpj')}}" type="button" class="btn btn-primary" data-toggle="tooltip" title="Pessoa Jurídica"><i class="fas fa-building"></i> Pessoa Jurídica</a>
			</div>
