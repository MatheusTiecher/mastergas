		...
		<div class="modal-content">
			...
			<div class="modal-body">
						...
						<div class="col-md-12">
							<div class="form-group">
								<div class="form-group">
									...
									<select class="form-control js-data-cliente-ajax {{$errors->has('cliente_id') ? 'is-invalid' : '' }}" id="cliente_id" name="cliente_id" data-toggle="select" title="Simple select" data-live-search="true" data-minimum-results-for-search="Infinity" required="true"> </select>
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn btn-outline-default"><i class="fas fa-arrow-circle-right" data-toggle="tooltip" title="Iniciar Venda"></i> Iniciar Venda</button>
				</div>
			</form>
		</div>
	</div>
