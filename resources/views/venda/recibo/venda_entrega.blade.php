...
<div class="border">
	<div class="clearfix">
		<div class="total" style="width: 50%;" align="center">
			<p><b>Total a pagar </b> R$ {{number_format(($total + $venda->frete - $venda->desconto), 2, ',', '.')}}</p>
		</div>
		<div class="total" style="width: 50%;" align="center">
	...
	<div class="border" style="margin-top: 5px;">
		<div class="clearfix">
			<div class="total">
				...
				<div class="title" style="padding-right: 25px;">
					<p><b>Venda código #{{$venda->id}} </b></p>
					<p>
						<b>Endereço </b> 
						...
						<br><b>Data entrega </b>{{$ocorrencia->dataagendada}}
					</p>
				</div>
			</div>
		</div>
