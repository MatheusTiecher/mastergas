    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-frame">
                <div class=" card-body">
                    <h1>Cadastro de novo endereço - {{$page['title']}}</h1>
                    <form action="{{$page['form']}}" method="POST">
                        <div class="row">
                            @csrf
                            @include('cliente._form2')
                        </div>
                        <a type="button" href="{{$page['cancelar']}}" class="btn btn-sm btn-outline-danger" data-toggle="tooltip" title="Cancelar"><i class="fas fa-times-circle"></i> Cancelar</a>
