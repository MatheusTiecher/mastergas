...
<div class="col-md-6">
	<div class="form-group">
		...
		<input type="text" name="quantidade" class="form-control form-control-sm {{$errors->has('quantidade') ? 'is-invalid' : '' }} money" placeholder="0" id="quantidade" value="{{old('quantidade', isset($estoque->quantidade) ? $estoque->quantidade : null)}}" minlength="1" maxlength="8">
...
<div class="col-md-6">
	<div class="form-group">
		...
		<input type="text" name="valorvenda" class="form-control form-control-sm {{$errors->has('valorvenda') ? 'is-invalid' : '' }} money" placeholder="0,00" id="valorvenda" value="{{old('valorvenda', isset($estoque->valorvenda) ? $estoque->valorvenda : null)}}" minlength="4" maxlength="8">
